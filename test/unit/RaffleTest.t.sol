...
contract RaffleTest is Test, CodeConstants {
    ...
    function testPickWinnerCanOnlyRunIfCheckUpkeepIsTrue() public raffleEntered {
        // Act // Assert
        raffle.pickWinner("");
    }

    function testPickWinnerRevertsIfCheckUpkeepIsFalse() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
    ...
    function testPickWinnerUpdatesRaffleStateAndEmitsRequestId() public raffleEntered {
        // Act
        vm.recordLogs();
        raffle.pickWinner("");
    ...
    function testFulfillRandomWordsCanOnlyBeCalledAfterPickWinner(uint256 randomRequestId)
        public
        raffleEntered
        skipFork
    {
